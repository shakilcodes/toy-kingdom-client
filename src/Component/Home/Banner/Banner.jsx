        ...
        <section className=' bg-[#bec6a5]'>
            <div className='banner-container max-w-[1280px] mx-auto' >
                <div className='flex justify-center items-center md:ml-32 '>
                    ...
                    <div className='mx-auto mt-36' data-aos="fade-left" data-aos-easing="linear"
                        data-aos-duration="1000">
                        <img className='w-[600px] rounded-[100px] h-auto' src="https://i.postimg.cc/9FyFLmmS/baner-final.jpg" alt="" />
                    </div>
                </div>
            </div>
        </section>
